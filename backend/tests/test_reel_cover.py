...
from lorescape_backend.social import reel_cover
...
@patch("lorescape_backend.social.reel_cover.card_storage.upload_card_png")
@patch("lorescape_backend.social.reel_cover.render_cover")
@patch("lorescape_backend.social.reel_cover.mapper.build_card_content")
@patch("lorescape_backend.social.reel_cover.load_place_row")
@patch("lorescape_backend.social.reel_cover.load_story_row")
