...
`lorescape_publisher.story_prompt`. This module composes those
...
from lorescape_publisher.story_prompt import (
    LANGUAGE_NAMES,
    build_story_system_instruction,
    build_story_user_prompt,
)
from lorescape_publisher.story_prompt import SourceBundle, SourceExtract
