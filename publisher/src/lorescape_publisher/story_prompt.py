...
Copied from backend/src/lorescape_backend/shared/story_prompt.py on
2026-07-11. Deliberately duplicated: backend and publisher are fully
decoupled (spec 2026-07-11-social-publisher-split-design.md, 決策 3).
"""
