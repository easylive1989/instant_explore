...
from lorescape_publisher.daily_story.job import LANGUAGES, run_once, run_with_retry
from lorescape_publisher.daily_story.gemini_client import GeneratedStory
from lorescape_publisher.daily_story.place_picker import PickedPlace
from lorescape_publisher.daily_story.wikipedia import LeadImage, WikipediaSummary
...
@patch("lorescape_publisher.daily_story.job.create_client")
@patch("lorescape_publisher.daily_story.job.place_picker.pick_next_place")
@patch("lorescape_publisher.daily_story.job.wikipedia.fetch_summary")
@patch("lorescape_publisher.daily_story.job.wikipedia.fetch_lead_image")
@patch("lorescape_publisher.daily_story.job.wikipedia.fetch_intro_extract")
@patch("lorescape_publisher.daily_story.job.wikipedia.fetch_langlink_url")
@patch("lorescape_publisher.daily_story.job.gemini_client.generate_story")
@patch("lorescape_publisher.daily_story.job.story_writer.insert_story")
@patch("lorescape_publisher.daily_story.job.place_picker.mark_place_used")
...
@patch("lorescape_publisher.daily_story.job.time.sleep")  # speed up retry
@patch("lorescape_publisher.daily_story.job.run_once")
@patch("lorescape_publisher.daily_story.job.discord_notify.notify_failure")
...
@patch("lorescape_publisher.daily_story.job.time.sleep")
@patch("lorescape_publisher.daily_story.job.run_once")
@patch("lorescape_publisher.daily_story.job.discord_notify.notify_failure")
...
@patch("lorescape_publisher.daily_story.job.create_client")
@patch("lorescape_publisher.daily_story.job.render_card")
@patch("lorescape_publisher.daily_story.job.discord_review.send_for_review")
def test_send_today_for_review_renders_card_and_posts_image(
    send, render, create, fake_config
):
    from datetime import date as _date
    from lorescape_publisher.daily_story.job import send_today_for_review
...
@patch("lorescape_publisher.daily_story.job.run_with_retry")
@patch("lorescape_publisher.daily_story.job.send_today_for_review")
...
def test_run_once_passes_per_language_response_schema(
    ...
    from lorescape_publisher.daily_story import prompts
