...
from lorescape_publisher.daily_story.gemini_client import (
    GEMINI_MODEL,
    GeneratedStory,
    generate_story,
)
from lorescape_publisher.genai import BACKEND_AI_STUDIO, GenaiSettings

_SETTINGS = GenaiSettings(backend=BACKEND_AI_STUDIO, api_key="key")


@patch("lorescape_publisher.daily_story.gemini_client.build_client")
