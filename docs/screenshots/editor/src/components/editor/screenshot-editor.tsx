  ...
  async function captureSlide(
    ...
    try {
      const dataUrl = await toPng(el, {
        ...
        // Skip embedding webfonts: the large CJK faces (Noto/Ma Shan Zheng)
        // make html-to-image hang. The isolated SVG render falls back to
        // system fonts (PingFang for CJK, a system script for Latin), which
        // is fine for our text. Loaded fonts still drive the live preview.
        skipFonts: true,
      });
      return dataUrl;
    } finally {
