...
HooksApiResult _happyHooksResult() {
  return const HooksApiResult(hooks: [], insufficientSource: false);
}

void main() {
  late _MockClient client;
  late StoryHookApiService service;

  setUp(() {
    client = _MockClient();
    service = StoryHookApiService(client);
  });

  test(
    'Given a Place with wikidata-prefixed id '
    'When service.generateHooks is called '
    ...
    () async {
      ...
      ).thenAnswer((_) async => _happyHooksResult());
